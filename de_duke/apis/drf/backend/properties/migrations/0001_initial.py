    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commercial_type', models.CharField(choices=[('Office', 'Office'), ('Shop', 'Shop'), ('Home', 'Home'), ('land', 'Land')], max_length=50)),
                ('architectural_style', models.CharField(blank=True, choices=[('Modern', 'Modern'), ('Traditional', 'Traditional'), ('Industrial', 'Industrial')], max_length=50, null=True)),
                ('property_condition', models.CharField(blank=True, choices=[('New', 'New'), ('Under Renovation', 'Under Renovation'), ('Under Construction', 'Under Construction'), ('Bank Owned', 'Bank Owned')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shortlet_type', models.CharField(choices=[('Hostel', 'Hostel'), ('Hotel', 'Hotel'), ('1 Bedroom', '1 Bedroom'), ('2 Bedroom', '2 Bedroom'), ('3 Bedroom', '3 Bedroom')], max_length=50)),
                ('total_bathrooms', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='banned', to='properties.property')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_phase', models.CharField(choices=[('Pending', 'Pending'), ('Phase 1', 'Phase 1'), ('Phase 2', 'Phase 2'), ('Verified', 'Verified'), ('Rejected', 'Rejected')], default='Pending', max_length=50)),
